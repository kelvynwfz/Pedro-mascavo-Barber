...
const ArenaExperience = () => {
  ...
  return (
    <section id="arena" className="py-32 bg-navy-deep relative overflow-hidden">
      <div className="container mx-auto px-6">
        <div className="bg-charcoal rounded-[60px] overflow-hidden border border-white/5 shadow-2xl relative">
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="p-12 md:p-20 flex flex-col justify-center">
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-navy-petrol/50 border border-navy-petrol/50 mb-8">
                ...
                <p className="text-xl text-silver/60 leading-relaxed mb-12">
                  {CONTENT.arena.text}
                </p>
                ...
                <div className="flex flex-wrap gap-8 mb-12">
                  {amenities.map((item) => (
                    <div key={item.label} className="flex items-center gap-3">
                      <item.icon className="w-6 h-6 text-orange-burnt" />
                ...
                <div className="flex flex-col sm:flex-row gap-6">
                  <a 
                    ...
                    className="px-8 py-5 bg-orange-burnt text-ice font-bold uppercase tracking-widest rounded-xl hover:bg-orange-vibrant transition-all flex items-center justify-center gap-3"
                  >
                  ...
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-8 py-5 border border-white/10 text-ice font-bold uppercase tracking-widest rounded-xl hover:bg-white/5 transition-all flex items-center justify-center gap-3"
                  >
